...
/***/ function(module, exports, __webpack_require__) {
	...
	var $__0 = Router,
	    ...
	    NotFoundRoute = $__0.NotFoundRoute,
	...
	var App = React.createClass({ displayName: 'App',
	  render: function render() {
	    return React.createElement('div', null, React.createElement('nav', { className: 'navbar navbar-default' }, React.createElement('div', { className: 'container-fluid' }, React.createElement('div', { className: 'navbar-header' }, React.createElement('button', { type: 'button', className: 'navbar-toggle collapsed', 'data-toggle': 'collapse', 'data-target': '#navbar-collapse' }, React.createElement('span', { className: 'icon-bar' }), React.createElement('span', { className: 'icon-bar' }), React.createElement('span', { className: 'icon-bar' })), React.createElement('a', { className: 'navbar-brand', href: '#' }, React.createElement('img', { src: '../images/logo.png' }))), React.createElement('div', { className: 'collapse navbar-collapse', id: 'navbar-collapse' }, React.createElement('ul', { className: 'nav navbar-nav' }, React.createElement('li', { className: 'active' }, React.createElement('a', { href: '#' }, 'Link')), React.createElement('li', null, React.createElement('a', { href: '#' }, 'Link')))))), React.createElement(RouteHandler, null));
	  }
	});
	...
	var Index = React.createClass({ displayName: 'Index',
	  render: function render() {
	    return React.createElement('h2', null, 'Index page');
	  }
	});

	var routes = React.createElement(Route, { handler: App }, React.createElement(DefaultRoute, { handler: Index }), React.createElement(Route, { name: 'index', path: '/', handler: Index }), React.createElement(NotFoundRoute, { handler: NotFound }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(51);
	var warning = __webpack_require__(53);
	var PathUtils = __webpack_require__(61);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stringify = __webpack_require__(198);
